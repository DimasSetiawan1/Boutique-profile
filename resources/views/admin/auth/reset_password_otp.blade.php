...
<head>
    ...
    <title>Verifikasi OTP Reset Password - Boutique Design</title>
    <!-- Google Fonts -->
...
<body>
    ...
    <div class="login-card">
        ...
        <h4 class="fw-bold mb-2" style="color:#1e293b;">Verifikasi Kode Reset</h4>
        ...
        <form action="{{ route('admin.password.otp.verify') }}" method="POST" id="otpForm">
            ...
            <button type="submit" class="btn-verify mb-3">
                Verifikasi Kode <i class="bi bi-arrow-right-circle ms-1"></i>
            </button>
        </form>
        ...
        <div class="mt-4 pt-3 border-top">
            <a href="{{ route('admin.password.forgot') }}" class="back-btn">
                <i class="bi bi-arrow-left"></i> Ganti alamat email
            </a>
        </div>
    </div>
